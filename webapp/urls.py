...
from webapp.views import IndexView, SketchpadView, CreateSketchpad, UpdateSketchpad, DeleteSketchpad, CreateProject, \
    ProjectView, IndexSketchpadView, UpdateProject, DeleteProject, AddUsers, ViewUsers
